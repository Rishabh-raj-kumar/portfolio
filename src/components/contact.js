...
export default function Contact(){
    return (
        ...
        <div className="container px-5 py-24 mx-auto flex sm:flex-nowrap flex-wrap">
          ...
          <iframe className="w-full h-full absolute left-0 top-0" id="gmap_canvas" src="https://maps.google.com/maps?q=Ranchi&t=&z=10&ie=UTF8&iwloc=&output=embed" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"></iframe>
